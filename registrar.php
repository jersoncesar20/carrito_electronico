                                ...
                                <div class="card-body">
                                    ...
                                    <form>
                                        <div class="form-group">
                                            ...
                                            <input type="Number" id="simpleinput" class="form-control" placeholder="">
                                        </div>

                                        <div class="form-group">
                                            <label for="example-password">APELLIDOS_NOMBRE</label>
                                            <input type="text" id="example-text" class="form-control" value="">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label for="example-password">TELEFONO</label>
                                            <input type="Number" id="example-number" class="form-control" value="number">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label for="example-password">FECHA_NACIMIENTO</label>
                                            <input type="Number" id="example-number" class="form-control" value="number">
                                        </div>
