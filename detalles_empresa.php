                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="form-group row ">
                                <label class="col-lg-2 col-md-2 col-sm-12" for="">Logo</label>
                                <input type="file"class="form-control col-lg-4 col-md-4 col-sm-12"  name="nacimiento"placeholder="Ingrese el Direccion de envio "required>
